...
<head>
    ...
    <!-- Custom CSS-->
    <link href="{{ asset('/landing/css/general.css') }}" rel="stylesheet">
    ...
    <script src="{{ asset('/landing/js/modernizr-2.8.3.min.js') }}"></script>  <!-- Modernizr /-->
    <!--[if IE 9]>
    <script src="{{ asset('/landing/js/PIE_IE9.js') }}"></script>
    <![endif]-->
    <!--[if lt IE 9]>
    <script src="{{ asset('/landing/js/PIE_IE678.js') }}"></script>
    <![endif]-->
    ...
    <div class="col-xs-12 text-center abcen1">
        ...
        <ul class="list-inline intro-social-buttons">
            @if (Route::has('login'))
                ...
                @auth
                    <li><a href="{{ url('/home') }}" class="btn  btn-lg mybutton_cyano wow fadeIn" data-wow-delay="0.8s"><span class="network-name">HOME</span></a>
                    </li>
                @else
                    <li id="download" ><a href="{{ route('login') }}" class="btn  btn-lg mybutton_standard wow swing wow fadeIn" data-wow-delay="1.2s"><span class="network-name">INICIAR SESION</span></a>
                    </li>
                    <li id="download" ><a href="{{ route('register') }}" class="btn  btn-lg mybutton_standard wow swing wow fadeIn" data-wow-delay="1.2s"><span class="network-name">REGISTRO</span></a>
                    </li>
                @endauth
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-4 wow fadeInDown text-center">
                <img class="rotate" src="{{ asset('/landing/img/icon/tweet.svg')}}" alt="Generic placeholder image">
                <h3>Follow Me</h3>
            ...
            <div class="col-sm-4 wow fadeInDown text-center">
                <img  class="rotate" src="{{ asset('/landing/img/icon/picture.svg')}}" alt="Generic placeholder image">
                <h3>Gallery</h3>
                <p class="lead">Epsum factorial non deposit quid pro quo hic escorol. Olypian quarrels et gorilla congolium sic ad nauseum. </p>
                <!-- <p><a class="btn btn-embossed btn-primary view" role="button">View Details</a></p> -->
            </div><!-- /.col-lg-4 -->
            ...
            <div class="col-sm-4 wow fadeInDown text-center">
                <img  class="rotate" src="{{ asset('/landing/img/icon/retina.svg')}}" alt="Generic placeholder image">
                <h3>Retina</h3>
                <p class="lead">Epsum factorial non deposit quid pro quo hic escorol. Olypian quarrels et gorilla congolium sic ad nauseum. </p>
                <!-- <p><a class="btn btn-embossed btn-primary view" role="button">View Details</a></p> -->
            </div><!-- /.col-lg-4 -->
        ...
        <div class="row tworow">
            ...
            <div class="col-sm-4  wow fadeInDown text-center">
                <img class="rotate" src="{{ asset('/landing/img/icon/laptop.svg')}}" alt="Generic placeholder image">
                <h3>Responsive</h3>
                <p class="lead">Epsum factorial non deposit quid pro quo hic escorol. Olypian quarrels et gorilla congolium sic ad nauseum. </p>
                <!-- <p><a class="btn btn-embossed btn-primary view" role="button">View Details</a></p> -->
            </div><!-- /.col-lg-4 -->
            ...
            <div class="col-sm-4 wow fadeInDown text-center">
                <img  class="rotate" src="{{ asset('/landing/img/icon/map.svg')}}" alt="Generic placeholder image">
                <h3>Google</h3>
                <p class="lead">Epsum factorial non deposit quid pro quo hic escorol. Olypian quarrels et gorilla congolium sic ad nauseum. </p>
                <!-- <p><a class="btn btn-embossed btn-primary view" role="button">View Details</a></p> -->
            </div><!-- /.col-lg-4 -->
            ...
            <div class="col-sm-4 wow fadeInDown text-center">
                <img  class="rotate" src="{{ asset('/landing/img/icon/browser.svg')}}" alt="Generic placeholder image">
                <h3>Bootstrap</h3>
                <p class="lead">Epsum factorial non deposit quid pro quo hic escorol. Olypian quarrels et gorilla congolium sic ad nauseum. </p>
                <!-- <p><a class="btn btn-embossed btn-primary view" role="button">View Details</a></p> -->
            </div><!-- /.col-lg-4 -->
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 pull-right wow fadeInRightBig">
                <img class="img-responsive " src="{{ asset('/landing/img/ipad.png')}}" alt="">
            </div>
        ...
        <div class="row">
            <div class="col-sm-6 wow fadeInLeftBig">
                <div id="owl-demo-1" class="owl-carousel">
                    <a href="{{ asset('/landing/img/iphone.png')}}" class="image-link">
                        <div class="item">
                            <img  class="img-responsive img-rounded" src="{{ asset('/landing/img/iphone.png')}}" alt="">
                        </div>
                    </a>
                    <a href="{{ asset('/landing/img/iphone.png')}}" class="image-link">
                        <div class="item">
...
<div class="content-section-a">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 pull-right wow fadeInRightBig">
                <img class="img-responsive" src="{{ asset('/landing/img/doge.png') }}" >
            </div>
    ...
    <div class="container">
        ...
        <div class="row wow bounceInUp" >
            <div id="owl-demo" class="owl-carousel">
                ...
                <a href="{{ asset('/landing/img/slide/1.png')}}" class="image-link">
                    <div class="item">
                        <img  class="img-responsive img-rounded" src="{{ asset('/landing/img/slide/1.png')}}'" alt="Owl Image">
                    </div>
                </a>

                <a href="{{ asset('/landing/img/slide/2.png')}}" class="image-link">
                    <div class="item">
                        <img  class="img-responsive img-rounded" src="{{ asset('/landing/img/slide/2.png')}}'" alt="Owl Image">
                    </div>
                </a>

                <a href="{{ asset('/landing/img/slide/3.png')}}" class="image-link">
                    <div class="item">
                        <img  class="img-responsive img-rounded" src="{{ asset('/landing/img/slide/3.png')}}" alt="Owl Image">
                    </div>
                </a>
...
<!-- Smoothscroll -->
<script type="text/javascript" src="{{ asset('/landing/js/jquery.corner.js')}}"></script>
<script src="{{ asset('/landing/js/wow.min.js')}}"></script>
<script>
    new WOW().init();
</script>
<script src="{{ asset('/landing/js/classie.js')}}"></script>
<script src="{{ asset('/landing/js/uiMorphingButton_inflow.js')}}"></script>
